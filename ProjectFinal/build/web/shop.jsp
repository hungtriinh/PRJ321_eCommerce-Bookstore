<%-- 
    Document   : shop
    Created on : Mar 4, 2021, 8:38:32 PM
    Author     : Hung Trinh
--%>

<%@page import="java.util.List"%>
<%@page import="model.ProductDAL"%>
                                                        ...
                                                        <div class="box-img-hover">
                                                            ...
                                                            <div class="mask-icon">
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <a class="cart" href="home?catid=${catid}&pid=${book.pid}&amount=1" onclick="showAlert()" method="post">Add to Cart</a>
                                                                    </c:otherwise>
                                                                </c:choose>
                        ...
                        <div class="product-categori">
                            ...
                            <div class="filter-sidebar-left">
                                ...
                                <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                    ...
                                    <a href="home?catid=cat1" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Literature"> Literature </a>
                                    <a href="home?catid=cat2" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Mystery"> Mystery </a>
                                    <a href="home?catid=cat3" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Romance"> Romance </a>
                                </div>
                            </div>
                        </div>
                    </div>
