<%-- 
    ...
    Created on : Mar 9, 2021, 10:47:28 PM
    Author     : Hung Trinh
--%>
                            ...
                            <div class="price-box-bar">
                                <div class="cart-and-bay-btn">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a class="btn hvr-hover" data-fancybox-close="" href="home?catid=${catid}&pid=${book.pid}&amount=1" onclick="showAlert()" method="post">Add to cart</a>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
