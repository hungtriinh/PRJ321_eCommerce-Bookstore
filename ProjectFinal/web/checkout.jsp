<%-- 
    Document   : checkout
    Created on : Mar 9, 2021, 10:28:19 PM
    Author     : Hung Trinh
--%>
                        ...
                        <div class="checkout-address">
                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback"> Please enter your shipping phone number. </div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="shipping-method-box">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="shippingOption3">Ninja Van</label> <span class="float-right font-weight-bold">FREE</span> 
                                </div>
                    ...
                    <div class="col-sm-6 col-lg-6 mb-3">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex shopping-box"> 
                                <div class="col-12 d-flex shopping-box"> 
                                    <a href="pay" class="ml-auto btn hvr-hover">Place Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
